...
function o.write(e, e)
	luci.sys.call('[ -n "$(nft list sets 2>/dev/null | grep \"easserver2_\")" ] && sh /usr/share/easserver2/nftables.sh flush_nftset_reload || sh /usr/share/easserver2/iptables.sh flush_ipset_reload > /dev/null 2>&1 &')
