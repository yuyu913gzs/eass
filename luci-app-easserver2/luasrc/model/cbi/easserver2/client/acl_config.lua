...
-- [[ ACLs Settings ]]--
s = m:section(NamedSection, arg[1], translate("ACLs"), translate("WIFI配置"))
s.addremove = false
s.dynamic = false
...
o:depends({ node = "default",  ['!reverse'] = true })
--]]
o = s:option(ListValue, "remote_dns_protocol", translate("DNS协议"))
o:value("tcp", "TCP")
o:value("doh", "DoH")
o:value("udp", "UDP")
o:depends({ node = "default",  ['!reverse'] = true })
...
---- DNS Forward
o = s:option(Value, "remote_dns", translate("DNS选择"))
